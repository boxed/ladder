...
{var C_6930 = (a[i]);if(cljs.core.truth_(C_6930.cljsIsDirty))
{C_6930.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_6932 = C.cljsRatom;if(!((ratom_6932 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_6932);
} else
{}
