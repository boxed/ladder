...
goog.require('cljs.reader');
goog.require('cljs.reader');
tailrecursion.cljson.EncodeTagged = (function (){var obj6695 = {};return obj6695;
})();
tailrecursion.cljson._encode = (function _encode(o){if((function (){var and__3431__auto__ = o;if(and__3431__auto__)
...
{var x__4070__auto__ = (((o == null))?null:o);return (function (){var or__3443__auto__ = (tailrecursion.cljson._encode[goog.typeOf(x__4070__auto__)]);if(or__3443__auto__)
{return or__3443__auto__;
} else
{var or__3443__auto____$1 = (tailrecursion.cljson._encode["_"]);if(or__3443__auto____$1)
...
{
var G__6696 = i__$1;
var G__6697 = cljs.core.rest.call(null,c);
i = G__6696;
c = G__6697;
continue;
}
...
tailrecursion.cljson.encode = (function encode(x){var temp__4090__auto__ = (function (){var and__3431__auto__ = cljs.core._STAR_print_meta_STAR_;if(cljs.core.truth_(and__3431__auto__))
...
{if((function (){var G__6701 = x;if(G__6701)
{var bit__4093__auto__ = null;if(cljs.core.truth_((function (){var or__3443__auto__ = bit__4093__auto__;if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{return G__6701.tailrecursion$cljson$EncodeTagged$;
}
})()))
{return true;
} else
{if((!G__6701.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,tailrecursion.cljson.EncodeTagged,G__6701);
} else
{return false;
}
}
...
{if((cljs.core.map_QMARK_.call(null,x)) && (!((function (){var G__6703 = x;if(G__6703)
{var bit__4093__auto__ = (G__6703.cljs$lang$protocol_mask$partition0$ & 67108864);if((bit__4093__auto__) || (G__6703.cljs$core$IRecord$))
{return true;
} else
{if((!G__6703.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IRecord,G__6703);
} else
{return false;
}
}
...
{var or__3443__auto__ = tailrecursion.cljson.interpret.call(null,x);if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
...
tailrecursion.cljson.decode_tagged = (function decode_tagged(o){var tag = (o[0]);var G__6705 = tag;if(cljs.core._EQ_.call(null,"z",G__6705))
...
{if(cljs.core._EQ_.call(null,"y",G__6705))
...
{if(cljs.core._EQ_.call(null,"k",G__6705))
{return cljs.core.keyword.call(null,(o[1]));
} else
{if(cljs.core._EQ_.call(null,"s",G__6705))
{var i = 1;var len = o.length;var out = cljs.core.transient$.call(null,cljs.core.PersistentHashSet.EMPTY);while(true){
if((i < len))
{{
var G__6706 = (i + 1);
var G__6707 = len;
var G__6708 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__6706;
len = G__6707;
out = G__6708;
continue;
...
{if(cljs.core._EQ_.call(null,"l",G__6705))
{var i = (o.length - 1);var out = cljs.core.List.EMPTY;while(true){
if((i > 0))
{{
var G__6709 = (i - 1);
var G__6710 = cljs.core.conj.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__6709;
out = G__6710;
continue;
}
...
{if(cljs.core._EQ_.call(null,"m",G__6705))
{var i = 1;var len = o.length;var out = cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY);while(true){
if((i < len))
{{
var G__6711 = (i + 2);
var G__6712 = len;
var G__6713 = cljs.core.assoc_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])),tailrecursion.cljson.decode.call(null,(o[(i + 1)])));
i = G__6711;
len = G__6712;
out = G__6713;
continue;
...
{if(cljs.core._EQ_.call(null,"v",G__6705))
{var i = 1;var len = o.length;var out = cljs.core.transient$.call(null,cljs.core.PersistentVector.EMPTY);while(true){
if((i < len))
{{
var G__6714 = (i + 1);
var G__6715 = len;
var G__6716 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__6714;
len = G__6715;
out = G__6716;
continue;
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var temp__4090__auto__ = (function (){var or__3443__auto__ = cljs.core.get.call(null,cljs.core.deref.call(null,cljs.reader._STAR_tag_table_STAR_),tag);if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
